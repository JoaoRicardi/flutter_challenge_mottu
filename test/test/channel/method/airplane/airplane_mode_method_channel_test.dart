...
void main() {
  ...
  group('Test on start listening from airplane mode', () {
    testWidgets('On start listening with success response',
      ...
      ///deve voltar
      var errorRes =
          await airPlaneMethodChannel.stopListeningToAirPlaneStatus();
      expect(errorRes, null);
      var successRes =
          await airPlaneMethodChannel.startListeningToAirPlaneStatus();
      expect(successRes, true);
    });

    testWidgets('On start listening with error response',
        (WidgetTester tester) async {
      tester.binding.defaultBinaryMessenger.setMockMethodCallHandler(_channel,
          (MethodCall methodCall) async {
        if (methodCall.method == "start") {
    ...
    testWidgets('On start listening with null value',
        (WidgetTester tester) async {
      tester.binding.defaultBinaryMessenger.setMockMethodCallHandler(_channel,
          (MethodCall methodCall) async {
        if (methodCall.method == "start") {
  ...
  group('Test on stop listening from airplane mode', () {
    testWidgets('On stop listening with success response',
        (WidgetTester tester) async {
      tester.binding.defaultBinaryMessenger.setMockMethodCallHandler(_channel,
          (MethodCall methodCall) async {
    ...
    testWidgets('On stop listening with error response',
        (WidgetTester tester) async {
      tester.binding.defaultBinaryMessenger.setMockMethodCallHandler(_channel,
          (MethodCall methodCall) async {
        if (methodCall.method == "stop") {
    ...
    testWidgets('On stop listening with null value',
        (WidgetTester tester) async {
      tester.binding.defaultBinaryMessenger.setMockMethodCallHandler(_channel,
          (MethodCall methodCall) async {
        if (methodCall.method == "stop") {
